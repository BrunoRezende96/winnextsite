...
export default function PrimaryButtonXS() {
  ...
  return (
    <div
      ...
      className="relative w-52 h-10 bg-transparent border border-white rounded-full flex items-center justify-center select-none overflow-hidden cursor-pointer"
    >
      {/* Barra verde de progresso */}
      <div
        className="absolute left-0 top-0 h-full bg-[#00C37A] rounded-full transition-all duration-200"
        style={{ width: `${dragX + 45}px` }}
      />

      {/* Texto central */}
      <span className="relative z-10 text-white font-medium pointer-events-none">
        Let’s Talk
      </span>
