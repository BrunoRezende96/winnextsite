...
export default function PrimaryButton() {
  ...
  return (
    <div
      ...
      className="relative w-64 h-12 bg-transparent border border-white rounded-full flex items-center justify-center select-none overflow-hidden cursor-pointer"
    >
